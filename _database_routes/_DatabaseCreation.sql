...
DROP SCHEMA IF EXISTS arpegio_service;
CREATE SCHEMA arpegio_service;
USE arpegio_service;
...
DROP SCHEMA IF EXISTS scales_service;
CREATE SCHEMA scales_service;
USE scales_service;
...
DROP SCHEMA IF EXISTS theory_service;
CREATE SCHEMA theory_service;
USE theory_service;
